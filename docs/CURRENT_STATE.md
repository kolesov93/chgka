...
- Active task: none.
- Branch: `main`
- Status: task 0031 is complete and published. GitHub `main` now contains the redacted history; the private hostname is absent from its current tree, all reachable historical snapshots, and commit messages. The legacy tag is unchanged and the VPS was not accessed.
